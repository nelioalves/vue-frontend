  ...
  export default {
    ...
    created : function () {
      if (localStorage.getItem('loggedIn') && localStorage.getItem('username')) {
        this.user.username=localStorage.getItem('username'); // cookies
        this.loggedIn=true;
      } else {
        this.loggedIn=false;
      }
    ...
    methods : {
      login () {
        ...
        // this.$http.options.xhr = {withCredentials : true};
          ...
          // success callback
          this.loggedIn=true;
          localStorage.setItem('loggedIn', 'true'); // cookies
          localStorage.setItem('username', this.user.username); // cookies
